...
export const CardComponentProg = ({ title }) => {
  ...
  return (
    <article className={styles.card} onClick={openDiagram}>
      ...
      <span
        className={`${styles.card__prog} ${
          green ? styles.card__prog_type_green : styles.card__prog_type_red
        } `}
      >
      ...
      <div className={styles.card__footer}>
        <div className={styles.card__maxmin}>
          <div>
            <p className={styles.card__maxminName}>
              Послезавтра, {dateTom.getDay()} {getMonthRus(dateTom)}{" "}
            </p>
            <span
              className={`${styles.card__maxminRes} ${styles.card__prog_type_red}`}
            >
              <img
                src={polygonImgRed}
                alt=""
                className={styles.card__img_type_small}
              />
              {max}
              {isRub ? " ₽" : " шт"}
            </span>
          ...
          <div>
            <p className={styles.card__maxminName}>
              {getDayOfWeek(dateTomTom)}, {dateTomTom.getDay()}{" "}
              {getMonthRus(dateTomTom)}
            </p>
            <span
              className={`${styles.card__maxminRes} ${styles.card__prog_type_green}`}
            >
              <img
                src={polygonImgGreen}
                alt=""
